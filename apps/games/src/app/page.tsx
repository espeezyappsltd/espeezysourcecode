        ...
        >
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', marginBottom: '1.25rem' }}>
              ...
              <span style={{ fontWeight: 900, fontSize: '1rem', color: '#f1f5f9', letterSpacing: '-0.01em' }}>Espeezy Games</span>
            </div>
            <p style={{ fontSize: '0.85rem', lineHeight: 1.7, color: '#64748b', maxWidth: '240px', marginBottom: '1.25rem' }}>
              Competitive skirmish games built for students. Play ranked matches, earn badges,
              and prove your knowledge in real time.
            </p>
            <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
              <span style={{ fontSize: '0.7rem', fontWeight: 700, padding: '0.25rem 0.6rem', background: 'rgba(99,102,241,0.12)', color: '#818cf8', borderRadius: '4px', letterSpacing: '0.05em' }}>COMING SOON</span>
              <span style={{ fontSize: '0.7rem', fontWeight: 700, padding: '0.25rem 0.6rem', background: 'rgba(16,185,129,0.12)', color: '#10b981', borderRadius: '4px', letterSpacing: '0.05em' }}>FREE</span>
            </div>
          </div>
          ...
          {/* Games */}
          <div>
            <h3 style={{ fontSize: '0.7rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.12em', color: '#475569', marginBottom: '1.25rem' }}>Games</h3>
            <ul style={{ listStyle: 'none', margin: 0, padding: 0, display: 'flex', flexDirection: 'column', gap: '0.65rem' }}>
              {[
                { href: '#skirmish', label: 'Skirmish Mode' },
                { href: '#ranked', label: 'Ranked Play' },
                { href: '#badges', label: 'Badges & XP' },
