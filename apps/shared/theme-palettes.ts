/** Shared Espeezy palettes — synced across Kanban & Games */
export type EspeezyPaletteTier = 'free' | 'pro' | 'premium'
export type EspeezyPalette = {
  name: string
  tier?: EspeezyPaletteTier
  colors: Record<string, string>
}

export const PALETTES: EspeezyPalette[] = [
  /* FREE THEMES */
  {
    name: 'Google Light',
    tier: 'free',
