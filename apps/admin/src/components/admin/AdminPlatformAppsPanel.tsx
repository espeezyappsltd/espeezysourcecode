...
export default function AdminPlatformAppsPanel() {
  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: 'minmax(200px, 280px) 1fr', gap: '1.5rem', alignItems: 'start' }}>
      <div className="admin-console-card" style={{ padding: '1rem' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
          <strong>Catalog</strong>
          <button type="button" className="admin-console-btn" onClick={startCreate} title="New app">
            <Plus size={16} aria-hidden />
          </button>
        </div>
        {loading && <p className="admin-console-muted">Loading…</p>}
      ...
      <div className="admin-console-card" style={{ padding: '1.25rem' }}>
        ...
        <div style={{ display: 'grid', gap: '0.75rem', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))' }}>
          <label>
            <span className="admin-console-muted" style={{ fontSize: '0.75rem' }}>Slug</span>
            <input
          ...
          <label>
            <span className="admin-console-muted" style={{ fontSize: '0.75rem' }}>Name</span>
            <input
              className="admin-console-input"
              value={draft.name ?? ''}
          ...
          <label>
            <span className="admin-console-muted" style={{ fontSize: '0.75rem' }}>Status</span>
            <select
              className="admin-console-input"
          ...
          <label>
            <span className="admin-console-muted" style={{ fontSize: '0.75rem' }}>Price (cents)</span>
            <input
              type="number"
              className="admin-console-input"
          ...
          <label style={{ gridColumn: '1 / -1' }}>
            <span className="admin-console-muted" style={{ fontSize: '0.75rem' }}>Price label (display)</span>
            <input
              className="admin-console-input"
          ...
          <label style={{ gridColumn: '1 / -1' }}>
            <span className="admin-console-muted" style={{ fontSize: '0.75rem' }}>Tagline</span>
            <input
              className="admin-console-input"
              value={draft.tagline ?? ''}
          ...
          <label style={{ gridColumn: '1 / -1' }}>
            <span className="admin-console-muted" style={{ fontSize: '0.75rem' }}>Description</span>
            <textarea
              className="admin-console-input"
              rows={3}
          ...
          <label style={{ gridColumn: '1 / -1' }}>
            <span className="admin-console-muted" style={{ fontSize: '0.75rem' }}>Stripe payment link</span>
            <input
              className="admin-console-input"
          ...
          <label style={{ gridColumn: '1 / -1' }}>
            <span className="admin-console-muted" style={{ fontSize: '0.75rem' }}>Download URL</span>
            <input
              className="admin-console-input"
          ...
          <label style={{ gridColumn: '1 / -1' }}>
            <span className="admin-console-muted" style={{ fontSize: '0.75rem' }}>Live hosted URL</span>
            <input
              className="admin-console-input"
          ...
          <label style={{ gridColumn: '1 / -1' }}>
            <span className="admin-console-muted" style={{ fontSize: '0.75rem' }}>Features (one per line)</span>
            <textarea
              className="admin-console-input"
              rows={4}
              value={featuresText}
          ...
          <label style={{ gridColumn: '1 / -1' }}>
            <span className="admin-console-muted" style={{ fontSize: '0.75rem' }}>DB setup (markdown)</span>
            <textarea
              className="admin-console-input"
              rows={5}
          ...
          <label style={{ gridColumn: '1 / -1' }}>
            <span className="admin-console-muted" style={{ fontSize: '0.75rem' }}>UI personalisation (markdown)</span>
            <textarea
              className="admin-console-input"
              rows={5}
          ...
          <label>
            <span className="admin-console-muted" style={{ fontSize: '0.75rem' }}>Sort order</span>
            <input
              type="number"
              className="admin-console-input"
          ...
          <label>
            <span className="admin-console-muted" style={{ fontSize: '0.75rem' }}>Accent</span>
            <input
              className="admin-console-input"
        ...
        <div style={{ display: 'flex', gap: '0.75rem', marginTop: '1.25rem', flexWrap: 'wrap' }}>
          <button type="button" className="admin-console-btn admin-console-btn--primary" disabled={saving} onClick={() => void save()}>
            <Save size={16} aria-hidden /> {saving ? 'Saving…' : 'Save'}
          </button>
          {selectedId && (
            <button type="button" className="admin-console-btn" disabled={saving} onClick={() => void remove()}>
