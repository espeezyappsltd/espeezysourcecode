...
export default function SsoBridgePage() {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#0a0a0a', color: 'white', fontFamily: 'system-ui, sans-serif', padding: '1rem' }}>
        ...
        {error ? (
          <>
            ...
            <button
              ...
              style={{ border: 'none', borderRadius: '10px', background: '#10b981', color: 'white', padding: '0.6rem 1rem', fontWeight: 700, cursor: 'pointer' }}
            >
              Go to Login
            </button>
          </>
