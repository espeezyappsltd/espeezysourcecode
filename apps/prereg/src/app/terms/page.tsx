    ...
    <main style={{ minHeight: '100vh', background: '#0a0a0a', color: 'white' }}>
      <div style={{ maxWidth: '880px', margin: '0 auto', padding: '5rem 1.5rem 4rem', lineHeight: 1.7 }}>
        ...
        {[
          ...
          {
            title: 'Payments',
            body: 'Paid features are billed through Stripe. Pricing, billing intervals, and cancellation policies are shown at checkout. All charges are in GBP unless otherwise stated. Refunds are issued at our discretion in accordance with our refund policy (see /docs/refund-policy).',
          },
          {
