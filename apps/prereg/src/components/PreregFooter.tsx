...
const DOCS_LINKS = [
  ...
  { href: '/docs/features/studios', label: 'Espeezy Studio' },
  { href: '/docs/features/articles', label: 'Articles & Blog' },
  { href: '/docs/features/dev-launch', label: 'Dev Launch' },
  { href: '/docs/features/roadmap', label: 'Academic Roadmap' },
  { href: '/docs/features/network', label: 'Peer Network' },
  { href: '/docs/features/marketplace', label: 'Resource Marketplace' },
